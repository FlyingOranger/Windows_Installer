...
// doesn't update or something in the file system... probbaly an os
// issue with caching.
if (process.argv[2] === "uninstall"){
    ...
    require('./FlyingOranger/lib/startup_manager').setState(false);
    
    return;
}

// alright we're not uninstalling, so we if we're going to update
updater( () => {
